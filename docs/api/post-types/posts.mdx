...
---|---|---
| `blog_featured_image` | boolean | Is the featured image displayed on the single post page? |
| `blog_cta_enable` | boolean | Should we enable a call to action section for this post? |
| `blog_cta_title` | string | The title to display in the call to action. |
| `blog_cta_content` | string | The content to display in the call to action. |
| `blog_cta_image` | string | The image to display in the call to action. |
| `blog_cta_label` | string | The button label to display in the call to action. | 
| `blog_cta_link` | string | The URL of the button in the call to action. |
